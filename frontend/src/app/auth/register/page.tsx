...
export default function RegisterPage() {
  ...
  // Get auth store
  const { register, githubLogin, isLoading, error, clearError } = useAuthStore()
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="space-y-8">
            <h1 className="text-4xl font-bold leading-tight">
              Start Your Journey with AI-Powered Business Intelligence
            </h1>
            <p className="text-lg text-primary-100">
              Join thousands of merchants who are saving hours every day with voice recording and smart analytics.
            </p>
